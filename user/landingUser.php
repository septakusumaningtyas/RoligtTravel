				...
				<div class="container">
					<div class="row fullscreen align-items-center justify-content-between">
						<div class="col-lg-6 col-md-6 banner-left">
							<h6 class="text-white">Made your holiday more fun</h6>
							<h1 class="text-white">Roligt Travel</h1>
							<p class="text-white">
								We always serve you with pleasure
							</p>
							<a href="booking.php" class="primary-btn text-uppercase">Get Started</a>
						</div>
					</div>
                </div>
            </div>					
