	...
	if (isset($_POST['submit'])){
		...
		if($code===0){
			...
			if(!in_array($_FILES["gambar"]["type"],$tipe_file)){
				...
				$upload_check=true;
				header("Location: pay.php?error=$error");
			}
			...
			if(!$upload_check AND move_uploaded_file($tmp,$path)){ 
				$query="insert into tb_transaksi (kode_cust,kode_pkt,bukti_trans,flag) values ('$kode_cust','$kode_pkt','$path','1')";
			...
			<div class="overlay overlay-bg"></div>
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						...
						<p class="text-white link-nav"><a href="landingUser.php">Home </a>  <span class="fas fa-arrow-right"></span>  <a href="booking.php"> Booking Page</a> <span class="fas fa-arrow-right"></span> <a href="booked.php"> Booked Page</a> <span class="fas fa-arrow-right"></span> <a href="pay.php"> Pay Page</a> <span class="fas fa-arrow-right"></span> <a href="confirmation.php"> Confirmation Page</a> </p> 
				        </div>	
				    </div>
			    </div>
		</section>
				...
				<div class="row align-items-center">
					<div class="col-lg-12 banner-right">
						<table id="booking" class="table table-stripped text-center mt-3" style="width:100%">
							...
							<tbody>
							<?php
							$query = "select * from tb_customer a inner join tb_transaksi b on a.kode_cust = b.kode_cust";
