...
<html>
    ...
    <body>
			...
			<div class="overlay overlay-bg"></div>
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						...
						<p class="text-white link-nav"><a href="landingUser.php">Home </a>  <span class="fas fa-arrow-right"></span>  <a href="booking.php"> Booking Page</a></p>
				        </div>	
				    </div>
			    </div>
		</section>
		...
		<section class="book-info-area section-gap">
			<div class="container">
                <h2 class="judul-book">Fill this form to booked the packages</h2>
				<div class="row align-items-center">
