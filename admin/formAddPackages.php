...
<html>
    ...
    <body>
        <main class="container" role="main" id="main">
            ...
            <div class="container">
                <h2 class="mt-3 text-center">Form Tambah Packages</h2>
                <div class="row mt-5">
                    <div class="col-md-2"></div>
                    <div class="col-md-8">
                        <form action="../process/actionAddPackages.php" method="POST" enctype="multipart/form-data">
                            <div class="form-group row">
                                <label class="col-md-3 col-form-label">Kode Paket</label>
                                <div class="col-md-9">
                                    <input type="text" name="kode_pkt" id="kode_pkt" class="form-control" placeholder="Kode Paket" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-3 col-form-label">Nama Paket</label>
                                <div class="col-md-9">
                                    <input type="text" name="nama_pkt" id="nama_pkt" class="form-control" placeholder="Nama Paket" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-3 col-form-label">Jml Hari</label>
                                <div class="col-md-9">
                                    <input type="number" name="hari" id="hari" class="form-control" placeholder="Jumlah Hari" required>
                                </div>
                            </div>
                            <div class="form-group row">
