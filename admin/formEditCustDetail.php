...
$query = "SELECT * FROM tb_cust_detail WHERE kode_cust = $kodeCustomer";
...
<html>
    ...
    <body>
        <main class="container" role="main" id="main">
            ...
            <div class="container">
                <h2 class="mt-3 text-center">Form Edit Customer Detail</h2>
                <div class="row mt-5">
                    <div class="col-md-2"></div>
                    <div class="col-md-8">
                        <form action="../process/actionEditCustDetail.php" method="POST" enctype="multipart/form-data">
                            <input type="hidden" name="kode_cust" id="kode_cust" value="<?php echo $item["kode_cust"] ?>">
                            <div class="form-group row">
                                <label class="col-md-3 col-form-label">Tujuan Customer</label>
                                <div class="col-md-9">
                                    <select name="tujuan-cust" id="tujuan_cust" class="form-control" value="<?php echo $item["tujuan_cust"] ?>">
                                        <?php
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <select name="kode_pkt" id="kode_pkt" class="form-control" value="<?php echo $item["kode_pkt"] ?>">
                                        <?php
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <select name="no_trans" id="no_trans" class="form-control" value="<?php echo $item["no_trans"] ?>">
                                        <?php
