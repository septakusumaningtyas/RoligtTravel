...
$query = "SELECT * FROM tb_penerbangan WHERE kode_penerbangan = '$kodePenerbangan'";
...
<html>
    ...
    <body>
        <main class="container" role="main" id="main">
            ...
            <div class="container">
                <h2 class="mt-3 text-center">Form Edit Penerbangan</h2>
                <div class="row mt-5">
                    <div class="col-md-2"></div>
                    <div class="col-md-8">
                        <form action="../process/actionEditPenerbangan.php" method="POST" enctype="multipart/form-data">
                            <div class="form-group row">
                                <label class="col-md-3 col-form-label">Kode Penerbangan</label>
                                <div class="col-md-9">
                                    <input type="text" name="kode_penerbangan" id="kode_penerbangan" class="form-control" placeholder="Kode Penerbangan" required value="<?php echo $item["kode_penerbangan"] ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-3 col-form-label">Nama Maskapai</label>
                                <div class="col-md-9">
                                    <input type="text" name="nama_maskapai" id="nama_maskapai" class="form-control" placeholder="Nama Maskapai" required value="<?php echo $item["nama_maskapai"] ?>">
                                </div>
                            </div>
                            <div class="form-group row mt-5">
                                <div class="col-md-4">
                                    <a name="backBtn" id="backBtn" class="btn btn-dark btn-block" href="dataPenerbangan.php" role="button">Kembali</a>
                                </div>
                                <div class="col-md-4">
