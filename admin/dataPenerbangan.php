    ...
    <body>
        <main class="container" role="main" id="main">
            ...
            <div class="container-table" id="data">
                <h2 class="mt-3 text-center">Data Penerbangan</h2>
                <?php
                    $message = '';
                    if(isset($_GET["error"])) {
                        $message = $_GET["error"];
                ...
                ?>
                <a href="formAddPenerbangan.php" class="btn btn-success mt-3">Tambah Penerbangan</a>
                <!-- <div class="row"> -->
                    <table id="penerbangan" class="table table-stripped text-center mt-3" style="width:100%">
                        <thead>
                            <tr>
                                <th>#</th>
                        ...
                        <tbody>
                        <?php
                        $query = "SELECT * FROM tb_penerbangan where flag='1'";
                        ...
                        if (mysqli_num_rows($result) > 0){
                            ...
                            while($row = mysqli_fetch_assoc($result)){
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <a href='formEditPenerbangan.php?id=$kode_penerbangan' class='btn btn-warning'>Update</a>
                                    <a href='../process/actionDeletePenerbangan.php?id=$kode_penerbangan' class='btn btn-danger'>Delete</a> </td>
                                </tr>
                                ";
                            }
                        }
