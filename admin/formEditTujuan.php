...
$query = "SELECT * FROM tb_tujuan WHERE kode_tujuan = '$kodeTujuan'";
...
<html>
    ...
    <body>
        <main class="container" role="main" id="main">
            ...
            <div class="container">
                <h2 class="mt-3 text-center">Form Edit Tujuan</h2>
                <div class="row mt-5">
                    <div class="col-md-2"></div>
                    <div class="col-md-8">
                        <form action="../process/actionEditTujuan.php" method="POST" enctype="multipart/form-data">
                            <input type="hidden" name="kode_tujuan" id="kode_tujuan" value="<?php echo $item["kode_tujuan"] ?>">
                            <div class="form-group row">
                                <label class="col-md-3 col-form-label">Nama Tujuan</label>
                                <div class="col-md-9">
                                    <input type="text" name="nama_tujuan" id="nama_tujuan" class="form-control" placeholder="Nama Tujuan" required value="<?php echo $item["nama_tujuan"] ?>">
                                </div>
                            </div>
                            <div class="form-group row mt-5">
                                <div class="col-md-4">
                                    <a name="backBtn" id="backBtn" class="btn btn-dark btn-block" href="dataTujuan.php" role="button">Kembali</a>
                                </div>
                                <div class="col-md-4">
