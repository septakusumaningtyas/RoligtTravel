...
$query = "SELECT * FROM tb_customer WHERE kode_cust = $kodeCustomer";
...
<html>
    ...
    <main class="container" role="main" id="main">
        ...
        <div class="container">
            <h2 class="mt-3 text-center">Form Edit Customer</h2>
            <div class="row mt-5">
                <div class="col-md-2"></div>
                <div class="col-md-8">
                    <form action="../process/actionEditCustomer.php" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                ...
                                value="<?php echo $item["nama_cust"] ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label">Alamat Customer</label>
                            <div class="col-md-9">
                                <input type="text" name="alamat_cust" id="alamat_cust" class="form-control" required
                                value="<?php echo $item["alamat_cust"] ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label">No Telp</label>
                            <div class="col-md-9">
                                <input type="text" name="no_telp_cust" id="no_telp_cust" class="form-control" required
                                value="<?php echo $item["no_telp_cust"] ?>">
                            </div>
                        </div>
