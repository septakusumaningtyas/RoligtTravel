...
<html>
    ...
    <body>
        <main class="container" role="main" id="main">
            ...
            <div class="container">
                <h2 class="mt-3 text-center">Form Tambah Tujuan</h2>
                <div class="row mt-5">
                    <div class="col-md-2"></div>
                    <div class="col-md-8">
                        <form action="../process/actionAddTujuan.php" method="POST" enctype="multipart/form-data">
                            <div class="form-group row">
                                <label class="col-md-3 col-form-label">Kode Tujuan</label>
                                <div class="col-md-9">
                                    <input type="text" name="kode_tujuan" id="kode_tujuan" class="form-control" placeholder="Kode Tujuan" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-3 col-form-label">Nama Tujuan</label>
                                <div class="col-md-9">
                                    <input type="text" name="nama_tujuan" id="nama_tujuan" class="form-control" placeholder="Nama Tujuan" required>
                                </div>
                            </div>
