...
<html>
    <head>
        <title>Data Customer Detail</title>
    ...
    <body>
        <main class="container" role="main" id="main">
            ...
            <div class="container-table" id="data">
                <h2 class="mt-3 text-center">Data Customer Detail</h2>
                <?php
                    $message = '';
                    if(isset($_GET["error"])) {
                        $message = $_GET["error"];
                ...
                ?>
                <a href="formAddCustDetail.php" class="btn btn-success mt-3">Tambah Data</a>
                <!-- <div class="row"> -->
                    <table id="customer" class="table table-stripped text-center mt-3" style="width:100%">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Kode Customer</th>
                        ...
                        <tbody>
                        <?php
                        $query = "SELECT * FROM tb_cust_detail where flag='1'";
                        ...
                        if (mysqli_num_rows($result) > 0){
                            ...
                            while($row = mysqli_fetch_assoc($result)){
                                ...
                                <tr>
                                    <td>" . $index++ . "</td>
                                    <td>" .$row["kode_cust"]. "</td>
                                    <td>" .$row["tujuan_cust"]. "</td>
                                    <td>" .$row["kode_pkt"]. "</td>
                                    <td>" .$row["no_trans"]. "</td>
                                    <td>" .$row["kode_hotel"]. "</td>
                                    <td>" .$row["kode_penerbangan"]. "</td>
                                    <td>
                                    <a href='formEditCustDetail.php?id=$kode_cust' class='btn btn-warning'>Update</a>
                                    <a href='../process/actionDeleteCustDetail.php?id=$kode_cust' class='btn btn-danger'>Delete</a> </td>
                                </tr>
                                ";
                            }
                        }
