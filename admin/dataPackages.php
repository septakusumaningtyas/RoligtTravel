    ...
    <body>
        <main class="container" role="main" id="main">
            ...
            <div class="container-table" id="data">
                ...
                ?>
                <a href="formAddPackages.php" class="btn btn-success mt-3">Tambah Paket</a>
                <!-- <div class="row"> -->
                    <table id="paket" class="table table-stripped text-center mt-3" style="width:100%">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Kode Paket</th>
                        ...
                        <tbody>
                        <?php
                        $query = "SELECT * FROM tb_packages where flag='1'";
                        ...
                        if (mysqli_num_rows($result) > 0){
                            ...
                            while($row = mysqli_fetch_assoc($result)){
                                ...
                                <tr>
                                    ...
                                    <td>" .$row["harga"]. "</td>
                                    <td>
                                    <a href='formEditPackages.php?id=$kode_pkt' class='btn btn-warning'>Update</a>
                                    <a href='../process/actionDeletePackages.php?id=$kode_pkt' class='btn btn-danger'>Delete</a> </td>
                                </tr>
                                ";
                            }
                        }
