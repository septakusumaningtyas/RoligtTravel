    ...
    <body>
        <main class="container" role="main" id="main">
            ...
            <div class="container-table" id="data">
                <h2 class="mt-3 text-center">Data Hotel</h2>
                <?php
                    $message = '';
                    if(isset($_GET["error"])) {
                        $message = $_GET["error"];
                ...
                ?>
                <a href="formAddHotel.php" class="btn btn-success mt-3">Tambah Data Hotel</a>
                <!-- <div class="row"> -->
                    <table id="hotel" class="table table-stripped text-center mt-3" style="width:100%">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Kode Hotel</th>
                        ...
                        <tbody>
                        <?php
                        $query = "SELECT * FROM tb_hotel where flag='1'";
                        $result = mysqli_query($con, $query);

                        if (mysqli_num_rows($result) > 0){
                            $index = 1;
                            while($row = mysqli_fetch_assoc($result)){
                                $kode_hotel = $row["kode_hotel"];
                                echo "
                                <tr>
                                    <td>" . $index++ . "</td>
                                    ...
                                    <td>
                                    <a href='formEditHotel.php?id=$kode_hotel' class='btn btn-warning'>Update</a>
                                    <a href='../process/actionDeleteHotel.php?id=$kode_hotel' class='btn btn-danger'>Delete</a> </td>
                                </tr>
                                ";
                            }
                        }
