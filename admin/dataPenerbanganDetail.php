...
<html>
    <head>
        <title>Data Penerbangan Detail</title>
    ...
    <body>
        <main class="container" role="main" id="main">
            ...
            <div class="container-table" id="data">
                <h2 class="mt-3 text-center">Data Penerbangan Detail</h2>
                <?php
                    $message = '';
                    if(isset($_GET["error"])) {
                        $message = $_GET["error"];
                ...
                <!-- <div class="row"> -->
                    <table id="penerbangan" class="table table-stripped text-center mt-3" style="width:100%">
                        ...
                        <tbody>
                        <?php
                        $query = "SELECT * FROM tb_penerbangan_detail where flag='1'";
                        ...
                        if (mysqli_num_rows($result) > 0){
                            ...
                            while($row = mysqli_fetch_assoc($result)){
                                ...
                                <tr>
                                    <td>" . $index++ . "</td>
                                    <td>" .$row["dari_bandara"]. "</td>
                                    <td>" .$row["ke_bandara"]. "</td>
                                    <td>" .$row["departure_date"]. "</td>
                                    <td>" .$row["return_date"]. "</td>
                                    <td>" .$row["jml_passenger"]. "</td>
                                </tr>
                                ";
                            }
                        }
