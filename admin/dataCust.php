    ...
    <body>
        <main class="container" role="main" id="main">
            ...
            <div class="container-table" id="data">
                <h2 class="mt-3 text-center">Data Customer</h2>
                <?php
                    $message = '';
                    if(isset($_GET["error"])) {
                        $message = $_GET["error"];
                ...
                ?>
                <a href="formAddCustomer.php" class="btn btn-success mt-3">Tambah Customer</a>
                <!-- <div class="row"> -->
                    <table id="customer" class="table table-stripped text-center mt-3" style="width:100%">
                        ...
                        <tbody>
                        <?php
                        $query = "SELECT * FROM tb_customer where flag='1'";
                        ...
                        if (mysqli_num_rows($result) > 0){
                            ...
                            while($row = mysqli_fetch_assoc($result)){
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <a href='formEditCustomer.php?id=$kode_cust' class='btn btn-warning'>Update</a>
                                    <a href='../process/actionDeleteCustomer.php?id=$kode_cust' class='btn btn-danger'>Delete</a> </td>
                                </tr>
                                ";
                            }
                        }
