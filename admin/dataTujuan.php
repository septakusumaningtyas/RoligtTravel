    ...
    <body>
        <main class="container" role="main" id="main">
            ...
            <div class="container-table" id="data">
                <h2 class="mt-3 text-center">Data Tujuan</h2>
                <?php
                    $message = '';
                    if(isset($_GET["error"])) {
                        $message = $_GET["error"];
                ...
                ?>
                <a href="formAddTujuan.php" class="btn btn-success mt-3">Tambah Tujuan</a>
                <!-- <div class="row"> -->
                    <table id="tujuan" class="table table-stripped text-center mt-3" style="width:100%">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Kode Tujuan</th>
                        ...
                        <tbody>
                        <?php
                        $query = "SELECT * FROM tb_tujuan where flag='1'";
                        ...
                        if (mysqli_num_rows($result) > 0){
                            ...
                            while($row = mysqli_fetch_assoc($result)){
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <a href='formEditTujuan.php?id=$kode_tujuan' class='btn btn-warning'>Update</a>
                                    <a href='../process/actionDeleteTujuan.php?id=$kode_tujuan' class='btn btn-danger'>Delete</a> </td>
                                </tr>
                                ";
                            }
                        }
