...
<html>
    ...
    <body>
        <main class="container" role="main" id="main">
            ...
            <div class="container">
                <h2 class="mt-3 text-center">Form Tambah Penerbangan</h2>
                <div class="row mt-5">
                    ...
                    <div class="col-md-8">
                        <form action="../process/actionAddPenerbangan.php" method="POST" enctype="multipart/form-data">
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="kode_penerbangan" id="kode_penerbangan" class="form-control" placeholder="Kode Penerbangan" required>
                                </div>
                            </div>
                            <div class="form-group row">
