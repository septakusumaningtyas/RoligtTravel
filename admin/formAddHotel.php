...
<html>
    ...
    <body>
        <main class="container" role="main" id="main">
            ...
            <div class="container">
                <h2 class="mt-3 text-center">Form Tambah Hotel</h2>
                <div class="row mt-5">
                    <div class="col-md-2"></div>
                    <div class="col-md-8">
                        <form action="../process/actionAddHotel.php" method="POST" enctype="multipart/form-data">
                            <div class="form-group row">
                                <label class="col-md-3 col-form-label">Kode Hotel</label>
                                <div class="col-md-9">
                                    <input type="text" name="kode_hotel" id="kode_hotel" class="form-control" placeholder="Kode Hotel" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-3 col-form-label">Nama Hotel</label>
                                <div class="col-md-9">
                                    <input type="text" name="nama_hotel" id="nama_hotel" class="form-control" placeholder="Nama Hotel" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-3 col-form-label">Kode Tujuan</label>
                                <div class="col-md-9">
                                    <select name="tujuan-cust" id="tujuan_cust" class="form-control">
                                        <?php
