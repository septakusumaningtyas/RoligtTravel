...
$query = "SELECT * FROM tb_hotel WHERE kode_hotel = '$kodeHotel'";
...
<html>
    ...
    <body>
        <main class="container" role="main" id="main">
            ...
            <div class="container">
                <h2 class="mt-3 text-center">Form Edit Hotel</h2>
                <div class="row mt-5">
                    <div class="col-md-2"></div>
                    <div class="col-md-8">
                        <form action="../process/actionEditHotel.php" method="POST" enctype="multipart/form-data">
                            <input type="hidden" name="kode_hotel" id="kode_hotel" value="<?php echo $item["kode_hotel"] ?>">
                            <div class="form-group row">
                                <label class="col-md-3 col-form-label">Nama Hotel</label>
                                <div class="col-md-9">
                                    <input type="text" name="nama_hotel" id="nama_hotel" class="form-control" placeholder="Nama Hotel" required value="<?php echo $item["nama_hotel"] ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-3 col-form-label">Kode Tujuan</label>
                                <div class="col-md-9">
                                    <select name="tujuan-cust" id="tujuan_cust" class="form-control" required value="<?php echo $item["kode_tujuan"] ?>">
                                        <?php
                            ...
                            <div class="form-group row mt-5">
                                <div class="col-md-4">
                                    <a name="backBtn" id="backBtn" class="btn btn-dark btn-block" href="dataHotel.php" role="button">Kembali</a>
                                </div>
                                <div class="col-md-4">
                                    <button name="clearFormBtn" id="clearFormBtn" class="btn btn-warning btn-block" role="button" onclick="clearForm()">Clear</button>
                                </div>
                                <div class="col-md-4">
                                    <input type="submit" name="tambah" class="btn btn-success btn-block" value="Ubah"/>
                                </div>
                            </div>
                        </form>
                    </div>
